...
public class Agenda {
    ...
    //Agenda records
    public void printGeslotenSessions (int minimumMuzikanten){
    System.out.println("Minimale 4 aantal muzikanten, ");
        for (Session session : sessions) {
            if (session instanceof GeslotenSession && ((GeslotenSession) session).getAantalMuzikanten()< minimumMuzikanten ){
